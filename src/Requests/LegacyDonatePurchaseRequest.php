...
use Omnipay\Alipay\Responses\LegacyDonatePurchaseResponse;
use Omnipay\Common\Message\ResponseInterface;

/**
 * Class LegacyDonatePurchaseRequest
 * @package Omnipay\Alipay\Requests
 * @link    https://doc.open.alipay.com/docs/doc.htm?treeId=108&articleId=104743&docType=1
 */
class LegacyDonatePurchaseRequest extends AbstractLegacyRequest
{
    protected $service = 'create_donate_trade_p';
    ...
    {
        return $this->response = new LegacyDonatePurchaseResponse($this, $data);
    }
